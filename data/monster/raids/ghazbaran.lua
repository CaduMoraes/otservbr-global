...
monster.loot = {
	...
	{name = "summerblade", chance = 1},
	{name = "crystalline axe", chance = 1},
	{name = "phantasmal axe", chance = 1},
	{name = "hammer of prophecy", chance = 1},
	{name = "mycological mace", chance = 1},
	{name = "ectoplasmic shield", chance = 1},
	{name = "energized limb", chance = 1},
	{name = "brain in a jar", chance = 1},
	{id = 34980, chance = 1},
	{name = "book backpack", chance = 1},
